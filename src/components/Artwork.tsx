...
export function MomentArt({ kind }: { kind: 'cup' | 'rain' | 'table' | 'moon' | 'flower' }) {
  return (
    <svg viewBox="0 0 130 150" fill="none" aria-hidden="true" className={`moment-art art-${kind}`}>
      {kind === 'cup' && (
        <>
          <ellipse cx="59" cy="114" rx="38" ry="6" />
          <path d="M29 63H85V89Q83 110 59 111Q33 110 29 89Z" />
          <path d="M85 67C117 63 113 97 84 95M44 48C32 34 57 29 44 14M63 48C50 34 76 29 63 14" />
          <ellipse cx="57" cy="63" rx="28" ry="5" />
        </>
      )}
      {kind === 'rain' && (
        <>
          <path d="M21 15H109V132H21ZM65 15V132M21 77H109" />
          <path d="M38 33L32 47M88 25L80 41M52 55L47 65M94 93L88 107M48 94L37 117M70 102L65 114" />
          <path d="M14 134H116" />
        </>
      )}
      {kind === 'table' && (
        <>
          <ellipse cx="65" cy="75" rx="48" ry="16" />
          <path d="M28 83L23 135M101 83L107 135M15 57V98H31M115 57V98H100" />
          <ellipse cx="42" cy="73" rx="13" ry="5" />
          <ellipse cx="87" cy="73" rx="13" ry="5" />
          <path d="M60 63V42H69V63M65 42V30M62 26Q55 15 65 10Q74 19 68 26" />
        </>
      )}
      {kind === 'moon' && (
        <>
          <path d="M86 20C25 12 17 89 66 101C102 111 124 68 108 46C108 87 55 84 57 46C57 29 72 19 86 20Z" />
          <path d="M19 128Q65 113 111 128M14 137H118M22 22V33M17 28H28" />
        </>
      )}
      {kind === 'flower' && (
        <>
          <path d="M65 134V64M65 116Q36 123 28 96Q57 91 65 116M65 98Q69 71 100 80Q96 105 65 98" />
          <path d="M65 60C21 89 20 29 51 39C29 8 90 6 79 37C113 10 119 74 84 60C102 98 44 109 65 60Z" />
          <circle cx="69" cy="51" r="10" />
        </>
      )}
    </svg>
  )
